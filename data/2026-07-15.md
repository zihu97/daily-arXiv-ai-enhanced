...
### [4] [Predicting Acceptance and Review Effort in Human and Agent Pull Requests](https://arxiv.org/abs/2607.12057)
...
### [5] [XScientist: A Git-Like Research Protocol for Long-Running Autonomous Scientific Discovery](https://arxiv.org/abs/2607.12301)
*Jixiang Luo*
...
### [6] [AutoTrace: From Patches to Triggers via Agentic Interprocedural Exploration](https://arxiv.org/abs/2607.12058)
...
### [7] [Beyond Test Presence: Assessing the Quality and Robustness of Agent-Generated Tests in Open-Source Projects](https://arxiv.org/abs/2607.12068)
...
### [8] [Fault Injection in OpenAPI Specifications for Evaluating Black-Box Testing Effectiveness](https://arxiv.org/abs/2607.12101)
...
### [10] [TestMiner: Software Testing Analysis for GitHub Repositories](https://arxiv.org/abs/2607.12223)
...
### [11] [WIP: Software Engineering Competencies in the Age of AI](https://arxiv.org/abs/2607.12259)
...
### [12] [Code-MUE: Measuring Code LLMs' Uncertainty through Execution-based Semantic Interaction Graphs](https://arxiv.org/abs/2607.12273)
...
### [13] [How Many Interviews Are Enough in a Software Engineering Study? Preliminary Findings on Sample Size and Saturation](https://arxiv.org/abs/2607.12326)
...
### [14] [Skills That Don't Exist: A Large-Scale Study of Hallucinated Skill Recommendation in LLM Agents](https://arxiv.org/abs/2607.12340)
...
### [15] [Detecting Rendering Bugs in Imperative Data Visualization Libraries via Equivalent Mutations](https://arxiv.org/abs/2607.12363)
...
### [16] [Automatic Testing of Interacting Autonomous Vehicles](https://arxiv.org/abs/2607.12452)
...
### [17] [CodeOwl: Automatic Generation of Tiered Parsons Problems for Introductory Programming](https://arxiv.org/abs/2607.12460)
...
### [18] [Understanding before Naming! Enhancing LLM-based Method Name Prediction with Code Summarization](https://arxiv.org/abs/2607.12467)
...
### [19] [Agent-Safety Evaluations as Load-Bearing Evidence: A Vendor-Neutral, Cross-Harness Reconstructability Metric](https://arxiv.org/abs/2607.12469)
*Oleg Solozobov*
...
### [20] [Taming the Drift: Context-aware Repair of Dockerfile Drift during Software Evolution](https://arxiv.org/abs/2607.12541)
...
### [21] [Evaluation Bias and Epistemic Inequality in Global Software Development](https://arxiv.org/abs/2607.12563)
...
### [22] [Hierarchical Fault Localization for Autonomous Driving Systems with Hypothesis Validation and Intent Analysis](https://arxiv.org/abs/2607.12598)
...
### [23] [Multi-Perspective Agentic Program Repair via Code Property Graphs and Temporal Execution Graphs](https://arxiv.org/abs/2607.12605)
...
### [24] [Line-Anchored Feedback Cuts Token Costs and Improves Correctness in AI Code Editing](https://arxiv.org/abs/2607.12713)
...
### [25] [Toward Localizing and Repairing Bias in Transformer Attention Heads](https://arxiv.org/abs/2607.12863)
*Sigma Jahan*
...
### [26] [Deep4ge: DNN Training Trajectories for Fault Detection and Diagnosis](https://arxiv.org/abs/2607.12868)
*Sigma Jahan*
...
### [27] [Salesforce Messaging Architecture: Platform Events, Async Sends, and Multi-Tenancy at Scale](https://arxiv.org/abs/2607.12943)
*Devam Gupta*
...
### [28] [Form, Not Content? A Preregistered, Placebo-Controlled Evaluation of Learned Error-Conditioned Self-Repair Through Prompts and Weights in Frozen Small Code Models](https://arxiv.org/abs/2607.12962)
*Mehmet Iscan*
...
### [29] [Software Supply Chains are Dead: Use-Case-Oriented Regeneration](https://arxiv.org/abs/2607.13021)
...
### [30] [Inference Pipelines as Operating-System Objects: Priority Scheduling and Constant-Footprint Streaming for Microcontroller Neural Inference](https://arxiv.org/abs/2607.12614)
*Dimitrios Kafetzis*
...
### [31] [Cross-Core Inference Offload as an Operating-System Service on Dual-Core Microcontrollers](https://arxiv.org/abs/2607.12620)
*Dimitrios Kafetzis*
...
### [32] [EMO: Energy Efficiency Modeling and Optimization for AI Workloads](https://arxiv.org/abs/2607.12324)
...
### [33] [MetaInfer: A Knowledge Only LLM Inference Engine Generator SKILL Toolbox](https://arxiv.org/abs/2607.12875)
...
### [34] [HARP-ME: Closure-Driven Exact Induced Motif Enumeration on GPUs](https://arxiv.org/abs/2607.12074)
...
### [37] [Decentralized Gradient Descent: Bottleneck Regimes and Budget Complexity](https://arxiv.org/abs/2607.12172)
*Nicolò Michelusi*
...
### [38] [Overcoming Orchestration Bottlenecks at Exascale: A Decentralized, Policy-Driven Approach for Sim-AI Ensembles](https://arxiv.org/abs/2607.12211)
...
### [39] [Profiling and Scheduling Complex O-RAN Applications Across the 5G Edge and Cloud](https://arxiv.org/abs/2607.12230)
...
### [40] [Parallelizing Legacy Mesh Generation Software: Lessons Learned from a Pseudo-Constrained Parallel Data Refinement Approach for Advancing Front Local Reconnection](https://arxiv.org/abs/2607.12253)
...
### [41] [HeteroMosaic: Exposing and Exploiting Heterogeneous Execution Opportunities for Energy-Efficient Edge LLM Inference](https://arxiv.org/abs/2607.12839)
...
### [42] [Scaling Synthetic-Image Pre-Training for Federated Fine-Tuning of Large Vision Models](https://arxiv.org/abs/2607.12583)
...
### [43] [Proceedings of HLPP 2026: 19th International Symposium on High-Level Parallel Programming and Applications](https://arxiv.org/abs/2607.12917)
...
### [44] [FPGA-Based Mini X-Ray Detector Front-End](https://arxiv.org/abs/2607.12126)
...
### [45] [ORRAM: An OpenROAD-Integrated RAM Generator Using Standard Cells](https://arxiv.org/abs/2607.12244)
...
### [46] [Emulated Integrity Replica: Enabling Self-Healing on FPGA SoCs via Hierarchical Twins](https://arxiv.org/abs/2607.12298)
...
### [47] [ArchSim: Computer Architecture Simulation as a Service](https://arxiv.org/abs/2607.12359)
...
### [48] [Realizable N:M Sparse Transformer Inference via Search-Kernel Co-Design](https://arxiv.org/abs/2607.12505)
...
### [49] [CLIP-3D: Closed-Loop Evaluation of Performance and Physical Constraints for 3D ICs](https://arxiv.org/abs/2607.12788)
...
### [50] [A 32-channel event-based bio-signal analog front-end with adaptive delta and pulse frequency encoding](https://arxiv.org/abs/2607.12901)
