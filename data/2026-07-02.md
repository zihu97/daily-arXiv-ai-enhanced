...
### [7] [Stochastic Connectivity as the Foundation of a Runtime Model for Microservice Availability Analysis](https://arxiv.org/abs/2607.00740)
...
### [8] [Prompting GPT-5 on Scrum Certification Questions: An Empirical Accuracy Study](https://arxiv.org/abs/2607.00049)
...
### [9] [SWE-Router: Routing in Multi-turn Agentic Software Engineering Tasks](https://arxiv.org/abs/2607.00053)
...
### [40] [HySpecPro: Scalable Hypergraph Partitioning via Spectral Projection Optimization](https://arxiv.org/abs/2607.00055)
...
### [41] [High-Performance NTT Accelerators for PQC leveraging Unified Redundant Arithmetic and Fine-Tuned Microarchitecture](https://arxiv.org/abs/2607.00621)
...
### [42] [A Role-Based Multi-Agent Model for Climate Adaptation Deliberation Across Living Labs](https://arxiv.org/abs/2607.00046)
...
### [43] [M2Note: Continual Evolution of Vision Language Models via Mistake Notebook Learning](https://arxiv.org/abs/2607.00685)
...
### [44] [Calibrating the Instrument: Controllability of an LLM-Driven Synthetic Population](https://arxiv.org/abs/2607.00910)
*Mirko Degli Esposti*
...
### [45] [SmoothAgent: Efficient Long-Horizon LLM-Based Agent Serving with Lookahead Context Engineering](https://arxiv.org/abs/2607.00151)
...
### [46] [Promise-Future Synchronization for Cluster Asynchronous Many-Task Runtimes via MPI One-Sided Communication](https://arxiv.org/abs/2607.00303)
*Mia Reitz*
...
### [47] [CloudyGUI: A Novel Python-based Framework for Auto-Scaling and Cloud Workload Analysis](https://arxiv.org/abs/2607.00455)
...
### [48] [ELDR: Expert-Locality-Aware Decode Routing for PD-Disaggregated MoE Serving](https://arxiv.org/abs/2607.00466)
...
### [49] [Modeling and Chasing the Energy-Efficiency Sweet Spots in Modern GPUs](https://arxiv.org/abs/2607.00819)
...
### [50] [Next-Generation Agentic Reinforcement Learning Systems Enable Self-Evolving Agents](https://arxiv.org/abs/2607.01120)
...
### [51] [MeshDNS: A Cooperative DNS Resolution Framework for Resource-Constrained IoT Networks](https://arxiv.org/abs/2607.00122)
...
### [52] [An LLM-Based Framework for Intent-Driven Network Topology Design](https://arxiv.org/abs/2607.00292)
...
### [53] [Robust Base Station Placement in Agricultural IoT via Bayesian Optimization](https://arxiv.org/abs/2607.00549)
...
### [54] [Vehicle-to-Grid as a 5G Smart Grid Vertical: Non-Technical Barriers and Implications for Communication Networks](https://arxiv.org/abs/2607.00589)
...
### [55] [Fluid-Spatiotemporal Stochastic Geometry: Information Flow in Non-Stationary Fields](https://arxiv.org/abs/2607.00616)
...
### [56] [5G Configured Grant Scheduling for 5G-TSN Integration for the Support of Industry 4.0](https://arxiv.org/abs/2607.00704)
...
### [57] [Common Radio Resource Management Policy for Multimedia Traffic in Beyond 3G Heterogeneous Wireless Systems](https://arxiv.org/abs/2607.00705)
...
### [58] [Latency-Sensitive 5G RAN Slicing for Industry 4.0](https://arxiv.org/abs/2607.00707)
...
### [59] [Mobile Base Station Positioning in Smart Ports Based on Kriged Sparse Measurements and Obstacle Inference](https://arxiv.org/abs/2607.00709)
...
### [60] [SNR-Adaptive Optimal Threshold Design for Energy Detection in Dynamic Spectrum Access](https://arxiv.org/abs/2607.00754)
...
### [61] [Data-driven mitigation of catastrophic forgetting in dynamic physical layer attack detection](https://arxiv.org/abs/2607.01041)
