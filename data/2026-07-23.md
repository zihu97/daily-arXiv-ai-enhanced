...
### [1] [Black-Box Performance Evaluation of Elastic Block Storage: Contract, Rate-Limiting Model, and Software Exploration](https://arxiv.org/abs/2607.20319)
...
### [2] [Fine-grained Computation-Communication Overlap via Tile-level Signaling and Scheduling for Mixture-of-Experts](https://arxiv.org/abs/2607.19539)
...
### [3] [Odin: Primitive-Level Synchronization for Distributed Point-Based Neural Rendering](https://arxiv.org/abs/2607.19893)
...
### [4] [Ascend to Science: Exploration of AI Chips for Scientific Computing](https://arxiv.org/abs/2607.20120)
...
### [5] [Fully Dynamic Rooted Spanning Tree on GPU](https://arxiv.org/abs/2607.20211)
...
### [6] [Scalable Multi-Controller Coordination in Periplus via Border-Switch Forwarding Graphs](https://arxiv.org/abs/2607.19508)
...
### [7] [Towards Ultra-High Reliability in Wi-Fi 8: IEEE 802.11bn Core Mechanisms, mmWave Integration, and Performance Verification](https://arxiv.org/abs/2607.19931)
...
### [8] [MoX: Efficient MoE Routing on Direct-Connect Topologies](https://arxiv.org/abs/2607.20220)
...
### [9] [SRAN: Scaling Named Data Networking via Map-and-Encap](https://arxiv.org/abs/2607.20363)
...
### [23] [CHMAS: A Coupled Hierarchical Framework for Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2607.19555)
...
### [24] [Same Game, Different Story: A Minimal Conservative Strategic Robustness Benchmark for Large Language Model Agents](https://arxiv.org/abs/2607.19670)
...
### [25] [Not Birds of a Feather: Personality-Based Partner Selection in LLM Agents](https://arxiv.org/abs/2607.19785)
...
### [26] [Dreamer-CPC: Message Learning with World Models for Decentralized Multi-agent Reinforcement Learning](https://arxiv.org/abs/2607.19809)
...
### [27] [Harnessing Disagreement: Detecting Correlated Agreement Blindness in Multi-Agent Triage](https://arxiv.org/abs/2607.19899)
...
### [28] [Opto-ViT-v2: Noise-Resilient On-Chip Fine-Tuning for Photonic Near-Sensor Vision Transformer Accelerators](https://arxiv.org/abs/2607.19421)
...
### [29] [BRIM: Workload-Balanced Dual-Sided Bit-Serial Sparse Inference Accelerator](https://arxiv.org/abs/2607.19431)
...
### [30] [BaseRT: Advancing Best-in-Class LLM Inference with Apple M5 Neural Accelerators](https://arxiv.org/abs/2607.19438)
...
### [31] [From Bit-Position Sensitivity to Unequal Error Protection for DNN Inference Memory](https://arxiv.org/abs/2607.19623)
...
### [32] [Leveraging ECRAM for Edge Continual Learning](https://arxiv.org/abs/2607.19661)
...
### [33] [Revisiting Hardware Priority Queue Architectures](https://arxiv.org/abs/2607.19881)
...
### [34] [DGNA: Dissecting GPU NUMA Architecture through Microbenchmarking and Data Analysis](https://arxiv.org/abs/2607.19922)
...
### [35] [Formal Foundations for Known Good Reliable Die Screening in Chiplet-Based AI Systems-on-Chip](https://arxiv.org/abs/2607.20141)
