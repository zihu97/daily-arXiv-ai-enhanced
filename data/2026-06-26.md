...
### [2] [Kiko: Programming Agents to Enact Interaction Protocols](https://arxiv.org/abs/2606.26156)
...
### [3] [Machine Learning-Driven Content Popularity Prediction and Cache Optimization in D2D Clustered Networks](https://arxiv.org/abs/2606.26119)
...
### [4] [Dot-Flik: A Scalable Edge AI Architecture for Distributed Insect Monitoring](https://arxiv.org/abs/2606.26121)
...
### [5] [Privacy-Aware Agent Collaboration for Dynamic VR Slice Management in 6G SD-RAN](https://arxiv.org/abs/2606.26123)
...
### [6] [Enhancing FANET Routing Resilience: A Fuzzy-Driven Bio-Inspired Approach and Its Quantitative Evaluation](https://arxiv.org/abs/2606.26124)
...
### [7] [Geometric Fairness-Aware Routing for Federated Edge Networks](https://arxiv.org/abs/2606.26125)
*Ratun Rahman*
...
### [8] [HALO: Hierarchical Auction-assisted Learning for Offloading in SAGIN](https://arxiv.org/abs/2606.26293)
...
### [9] [5G NR-V2X Scheduling Approaches for CPM Variable Size Traffic](https://arxiv.org/abs/2606.26746)
...
### [10] [An Experimental Assessment of the Spatial and Frequency Selectivity of Reconfigurable Intelligent Surfaces](https://arxiv.org/abs/2606.26808)
...
### [11] [Toward Agentic SysAdmin: Rethinking System Administration with AI Agents](https://arxiv.org/abs/2606.26960)
...
### [12] [Maximum Achievable Burst Size in All-Optical Satellite Networks](https://arxiv.org/abs/2606.27050)
...
### [13] [The Kernel's Write: Application Read-Only Memory](https://arxiv.org/abs/2606.26138)
...
### [14] [Mitigating High-Frequency Geometric Noise in Non-Parametric 1-Bit Sparse](https://arxiv.org/abs/2606.26137)
*Lars Kopp*
...
### [15] [Toward Mitigating Process-Induced Performance Degradation in 3.5D Heterogeneous Packages via Pre-Silicon Firmware Co-Optimization](https://arxiv.org/abs/2606.26176)
...
### [16] [CVA6-RT: an Open-Source Time-Predictable RV64 Processor for Mixed-Criticality Systems](https://arxiv.org/abs/2606.26177)
...
### [17] [Nanoelectromechanical Systems (NEMS) for Hardware Security in Advanced Packaging](https://arxiv.org/abs/2606.26426)
...
### [18] [GRAINS: Storage-Aware Algorithm-Architecture Co-Design Enabling High-Performance and Low-Cost Graph-Based Genome Analysis](https://arxiv.org/abs/2606.26468)
...
### [19] [SegFold: Accelerating Sparse GEMM with a Fine-Grained Dynamic Dataflow](https://arxiv.org/abs/2606.26701)
...
### [20] [Residual GPU Cache State on Apple M4 Pro](https://arxiv.org/abs/2606.27098)
...
### [21] [Evaluating Architectural Trade-offs in CGRAs: The Impact of Scratchpad Memory and Heterogeneity on Compute-Intensive Kernels](https://arxiv.org/abs/2606.27240)
...
### [22] [CHIA: An open-source framework for principled, agentic AI-driven hardware/software co-design research](https://arxiv.org/abs/2606.27350)
...
### [23] [Orchestrating Black-Box Schema Converters: An Empirical Study of Automated, Quality-Ranked Conversion Across Heterogeneous Schema Languages](https://arxiv.org/abs/2606.26180)
...
### [24] [Augmentation with Dilution: A Large-Scale Empirical Study of Human Contributor Ecosystems After AI Coding Agent Adoption](https://arxiv.org/abs/2606.26289)
...
### [25] [Towards Safety-Aware Mutation Testing for Autonomous Driving Systems](https://arxiv.org/abs/2606.26456)
*Donghwan Shin*
...
### [26] [An Empirical Study of LLM-Generated Specifications for VeriFast](https://arxiv.org/abs/2606.26490)
...
### [27] [Evaluation-Strategy Gap in Fault Diagnosis of Deep Learning Programs](https://arxiv.org/abs/2606.26492)
*Sigma Jahan*
...
### [28] [Same Scrutiny, More Time: Eye Tracking Insights into Reviewing LLM-Labelled Code](https://arxiv.org/abs/2606.26505)
...
### [29] [ConcoLixir: Reactive LLM Discovery Oracles for Python Concolic Testing](https://arxiv.org/abs/2606.26545)
...
### [30] [Quantum Mutant Equivalence via Transpilation](https://arxiv.org/abs/2606.26604)
...
### [31] [Knowledge-Based Pull Requests: A Trusted Workflow for Agent-Mediated Knowledge Collaboration](https://arxiv.org/abs/2606.26721)
...
### [32] [A Deterministic Control Plane for LLM Coding Agents](https://arxiv.org/abs/2606.26924)
*Padmaraj Madatha*
...
### [33] [Are LLMs Ready for Anti-Pattern Detection in Microservice Architectures?](https://arxiv.org/abs/2606.26927)
...
### [34] [CLIR: Liveness-Driven and Structure-Aware Fuzzing for the Cranelift Compiler](https://arxiv.org/abs/2606.26977)
...
### [35] [To Run or Not to Run: Analyzing the Cost-Effectiveness of Code Execution in LLM-Based Program Repair](https://arxiv.org/abs/2606.26978)
...
### [36] [How Much Static Structure Do Code Agents Need? A Study of Deterministic Anchoring](https://arxiv.org/abs/2606.26979)
...
### [37] [Cleaning Logs for Downstream Tasks (Registered Report)](https://arxiv.org/abs/2606.27000)
...
### [38] [The Spec Growth Engine: Spec-Anchored, Code-Coupled, Drift-Enforced Architecture for AI-Assisted Software Development](https://arxiv.org/abs/2606.27045)
*Hartwig Grabowski*
...
### [39] [ATGBuilder: Feature-Assisted Graph Learning for Activity Transition Graph Construction with Seed Supervision](https://arxiv.org/abs/2606.27080)
...
### [40] [On the Reproducibility of Quantum Software Defect Datasets: A Case Study of Bugs4Q](https://arxiv.org/abs/2606.27124)
...
### [41] [Smaller Models, Unexpected Costs: Trade-offs in LLM Quantization for Automated Program Repair](https://arxiv.org/abs/2606.27205)
...
### [42] [Beyond Objects](https://arxiv.org/abs/2606.27258)
*Daniel Jackson*
...
### [43] [Hot AI in Cold Space: Thermal-Crosstalk-Aware Scheduling for Sustainable Orbital AI Clusters](https://arxiv.org/abs/2606.26150)
...
### [44] [FinWhale: An Optimally Resilient Two-Round Terminating DAG Protocol](https://arxiv.org/abs/2606.26292)
...
### [45] [A Distributed Quantum Approximate Optimization Algorithm Simulator for Engineering Design Optimization](https://arxiv.org/abs/2606.26297)
...
### [46] [Priceless: An examination of Serverless Functions-as-a-Service (FaaS) pricing models](https://arxiv.org/abs/2606.26308)
*Nnamdi Ekwe-Ekwe*
...
### [47] [Moebius: Serving Mixture-of-Expert Models with Seamless Runtime Parallelism Switch](https://arxiv.org/abs/2606.26607)
...
### [48] [Simulating Unified Tensor Resharding in heterogeneous AI systems](https://arxiv.org/abs/2606.26633)
...
### [49] [RolloutPipe: Overlapping Pipelined Rollout and Training in Disaggregated On-Policy LLM Reinforcement Learning](https://arxiv.org/abs/2606.26997)
...
### [50] [DMuon: Efficient Distributed Muon Training with Near-Adam Overhead](https://arxiv.org/abs/2606.27153)
...
### [51] [CHAMB-GA: A Containerized HPC Scalable Microservice-Based Framework for Genetic Algorithms](https://arxiv.org/abs/2606.27217)
