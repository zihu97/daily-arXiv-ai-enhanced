...
### [2] [A Telemetry-Driven Model for Quantifying Upgrade Risk in Durable Workflow Execution](https://arxiv.org/abs/2607.13617)
...
### [3] [Compaction as Epistemic Failure: How Agentic LLM Tools Fabricate Confirmed Results from Killed Processes](https://arxiv.org/abs/2607.13071)
*Hiroki Tamba*
...
### [4] [Inference Economics of Enterprise Coding Agents: A Case Study of Cloud vs. On-Premise LLMs](https://arxiv.org/abs/2607.13080)
...
### [5] [Self-Improving AI Coding Agents Through Accumulated Behavioral Rules: A Closed-Loop Framework](https://arxiv.org/abs/2607.13091)
...
### [6] [SemaDiff: Identifying Semantic-Changing Commits with Generated Code and Tests](https://arxiv.org/abs/2607.13111)
...
### [7] [Design-System-Aware Development with AI: Evaluating Productivity and Design Consistency](https://arxiv.org/abs/2607.13156)
...
### [8] [From Human-Centric to Agentic Code Review: The Impact of Different Generations of Generative AI Technology on Review Quality](https://arxiv.org/abs/2607.13196)
...
### [9] [Can LLMs Learn and Apply Multi-Level Modelling Semantics? A First Empirical Study](https://arxiv.org/abs/2607.13257)
...
### [10] [Faithful Autoformalization of Natural Language Assertions](https://arxiv.org/abs/2607.13303)
...
### [16] [HybridQC: Hardware-Grounded Simulation of Tightly Integrated Hybrid Quantum-Classical Systems](https://arxiv.org/abs/2607.13352)
...
### [17] [The Café in Amsterdam: When the Incumbent Becomes the Oracle](https://arxiv.org/abs/2607.13393)
*Augusto Camargo*
...
### [18] [The Economics of AI Decoding Chips: Rebalancing Compute, Capacity, and Bandwidth for Efficient LLM Inference](https://arxiv.org/abs/2607.13068)
...
### [19] [ChipVerilog: A Large-Scale OpenCores-Derived Benchmark for LLM-Based Verilog RTL Generation](https://arxiv.org/abs/2607.13079)
...
### [20] [Microflow: Microarchitectural Causal Observability for Deep Cross-Layer Analysis and Optimization](https://arxiv.org/abs/2607.13184)
...
### [21] [Full-Pipeline Inference Optimization for MiMo-V2.5 Series: Pushing Hybrid SWA Efficiency to the Limit](https://arxiv.org/abs/2607.13095)
...
### [22] [No Attention, No Problem: DPU-Aware Attention Approximation in Modern YOLO on FPGA](https://arxiv.org/abs/2607.13106)
...
### [23] [A Reality Check on Quantum Optimisation: Evidence from an Industrial Case Study](https://arxiv.org/abs/2607.13325)
...
### [24] [CIMERA: Compute-in-Interconnect and Memory with Reconfigurable Precision for LLM Inference](https://arxiv.org/abs/2607.13649)
...
### [25] [Kaleido: Algorithm-Hardware Co-Design for Video Diffusion Transformers by Exploiting Latent Space Correlations](https://arxiv.org/abs/2607.13770)
...
### [26] [Jack of All Scales: A Versatile FPGA Tensor Block for MXFP Precisions](https://arxiv.org/abs/2607.13898)
...
### [27] [Learning Latency-Aware Orchestration for Multi-Agent Systems](https://arxiv.org/abs/2607.13359)
...
### [28] [Equilibrium stability as a driver of cooperation among Q-learners](https://arxiv.org/abs/2607.13607)
...
### [29] [Extending Liquid Rank Toward Multi-Source Reputation Aggregation](https://arxiv.org/abs/2607.13615)
...
### [30] [Social Simulations: from Agent-Based Modeling to Digital Twins](https://arxiv.org/abs/2607.13693)
...
### [31] [Pezego-HITL: A policy-grounded large language model architecture for agricultural extension in Ghana](https://arxiv.org/abs/2607.13934)
...
### [32] [Energy Minimization Oriented Resource Allocation for Integrated Sensing and Communication in Marine IoT Networks](https://arxiv.org/abs/2607.13462)
...
### [33] [Proactive URLLC Adaptation for Connected Vehicles Through ML-Based Channel Prediction](https://arxiv.org/abs/2607.13692)
...
### [34] [MARS: Multi-stage Accelerated Read Stack for Large-buffer Buffered Reads](https://arxiv.org/abs/2607.13604)
...
### [35] [Fair on the Surface: Transaction-Ordering Bias and MEV in Mysticeti DAG-based BFT Protocol](https://arxiv.org/abs/2607.13378)
...
### [36] [gDMC: A Generic Distributed Model Counting Framework via Work-Stealing](https://arxiv.org/abs/2607.13634)
...
### [37] [A Distributed Framework for Compiling and Reasoning with d-DNNF](https://arxiv.org/abs/2607.13642)
...
### [38] [Local Certification of Vertex and Edge Connectivity](https://arxiv.org/abs/2607.13677)
