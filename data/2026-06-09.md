...
### [1] [Selecting New Measurement Locations to Diversify Traffic-Pattern Coverage: A Real-World Evaluation for Total Traffic Volume Estimation](https://arxiv.org/abs/2606.07556)
...
### [2] [Spectrum Aggregation for 6G: Lessons from 5G Carrier Aggregation and Dual Connectivity](https://arxiv.org/abs/2606.07944)
*Xingqin Lin*
...
### [3] [Blockage-Aware Non-stationary Dynamic Bandit for User Association in mmWave V2X Networks](https://arxiv.org/abs/2606.08118)
...
### [4] [Systems-Level Planning and Coordination of Truck-Drone Collaborative Delivery Networks](https://arxiv.org/abs/2606.08738)
...
### [5] [Semantic and Task-Oriented V2X Communications: Pushing the Limits of V2X Networks Scalability](https://arxiv.org/abs/2606.09126)
...
### [6] [Just-in-time Restoration with Distributed Fiber Sensing in Metropolitan Optical Networks](https://arxiv.org/abs/2606.09533)
...
### [7] [STEPS: Semantic-Contract-Guided Scheduling for LLM-Assisted Natural-Language-Driven Edge AI Services](https://arxiv.org/abs/2606.09537)
...
### [8] [Strict-Priority Packet Delay in Switches with Transmit-Ring Buffering](https://arxiv.org/abs/2606.09619)
...
### [9] [Systematic LLM Translation of Legacy Scientific Code to Differentiable Frameworks: Application to a Land Surface Model](https://arxiv.org/abs/2606.07681)
...
### [10] [SWE-Marathon: Can Agents Autonomously Complete Ultra-Long-Horizon Software Work?](https://arxiv.org/abs/2606.07682)
...
### [11] [Review the Code, Not the Story: A Vision and Protocol for Code-First Peer Review](https://arxiv.org/abs/2606.07683)
*Jienan Chen*
...
### [12] [Are We Lost in the Woods? Detecting Silent Semantic Faults for Random Forest Classifiers with Data-informed Static Analysis](https://arxiv.org/abs/2606.07709)
...
### [13] [The Windows IOCTL Census: A Corpus-Scale, Multi-Architecture Database of the Driver Control-Code Surface](https://arxiv.org/abs/2606.07732)
*Michael J. Bommarito*
...
### [14] [Sensitivity Analysis White Paper](https://arxiv.org/abs/2606.07809)
...
### [15] [Jas: AI-Paired Engineering as a Revival of N-Version Programming](https://arxiv.org/abs/2606.07828)
*Jason Hickey*
...
### [16] [Academic Integrity and Emotional Responses to Inappropriate LLM Use in Software Engineering Education](https://arxiv.org/abs/2606.07830)
...
### [17] [Autonomous Incident Resolution at Hyperscale: An Agentic AI Architecture for Network Operations](https://arxiv.org/abs/2606.09122)
*Arun Malik*
...
### [18] [SLRMentor: An LLM-Based Tool Supporting Learning of SLR in Software Engineering](https://arxiv.org/abs/2606.07831)
...
### [19] [Cherry-pick Override: Unsafe Directional Commitment in LLM Judges under Mixed Evidence](https://arxiv.org/abs/2606.07834)
*Haoran Xu*
...
### [20] [A Preliminary Model for Managing Technical Debt in an Agile Environment](https://arxiv.org/abs/2606.07859)
*Pedro E. Colla*
...
### [21] [DD-GEPA: Prompt Optimization for Dialogue Disentanglement Focusing on Task Instruction and Utterance Representation](https://arxiv.org/abs/2606.07894)
...
### [22] [Identifying unique developers in OSS projects: A family of models](https://arxiv.org/abs/2606.08096)
...
### [23] [TICoder: A Repository-Level Code Generation Framework with Test-Driven Planning and Implementation-Aware Reuse](https://arxiv.org/abs/2606.08135)
...
### [24] [FASE: Fast Adaptive Semantic Entropy for Code Quality](https://arxiv.org/abs/2606.09800)
...
### [25] [Minimum Complete MR Subsets under Semantic-Mutation Fault Models: A Support-Set Domination Boundary](https://arxiv.org/abs/2606.08269)
...
### [26] [Impacts of Histories and Models on LLM Grading: A Study in Advanced Software Engineering Courses](https://arxiv.org/abs/2606.08400)
...
### [27] [When LLMs Invent Rust Crates: An Empirical Study of Hallucination Patterns and Mitigation](https://arxiv.org/abs/2606.08444)
...
### [28] [Projecting the Emerging Mindset of SWE Agent by Launching a Wild Code Understanding Journey](https://arxiv.org/abs/2606.08500)
...
### [29] [Auditable Graph-Guided Root Cause Analysis for Kubernetes Incidents](https://arxiv.org/abs/2606.08590)
...
### [30] [FusionVul: A Multimodal Feature Fusion Framework for Source Code Vulnerability Detection](https://arxiv.org/abs/2606.08553)
...
### [31] [LLM vs. Human Unit Tests: Fault Detection on Real Python Bugs](https://arxiv.org/abs/2606.08588)
...
### [32] [Lost in the Flow with Code Talkers: Unveiling the Instruction-Tuning Tax of Large Language Models in Code Tasks](https://arxiv.org/abs/2606.08676)
...
### [33] [Structuring agentic AI for HPC code modernization](https://arxiv.org/abs/2606.08710)
...
### [34] [AI-Augmented Closed-Loop Quality Engineering: A Reference Architecture for Continuous Software Quality Intelligence](https://arxiv.org/abs/2606.08793)
*Dimple Bajaj*
...
### [35] [Governance Controls for AI-Generated Test Artifacts in Autonomous Software Testing](https://arxiv.org/abs/2606.08806)
...
### [36] [Syntax-driven Incremental Program Verification of Matching Logic Properties](https://arxiv.org/abs/2606.08824)
...
### [37] [ATTAIN: Automated Exploit Failure Analysis through Trace-Driven Diff Analysis](https://arxiv.org/abs/2606.09060)
...
### [38] [Context Rot in AI-Assisted Software Development: Repurposing Documentation Consistency for AI Configuration Artifacts](https://arxiv.org/abs/2606.09090)
...
### [39] [Understanding How Enterprises Adopt the Model Context Protocol for LLM-Driven Software Engineering](https://arxiv.org/abs/2606.09182)
...
### [40] [Empirical Study for Structured Output Control in LLMs for Software Engineering](https://arxiv.org/abs/2606.09395)
...
### [41] [Relocate and Emulate: Re-Hosting Android's Application Layer](https://arxiv.org/abs/2606.09528)
...
### [42] [Agentic Persona Generation with Critique-Refinement: An Industrial Evaluation](https://arxiv.org/abs/2606.09637)
...
### [43] [TOMOYO Linux: A Mandatory Access Control Method Based on Application Execution State](https://arxiv.org/abs/2606.08060)
...
### [44] [TinyContainer: Container Runtime Middleware Enabling Multi-tenant Microcontrollers with Built-in Security](https://arxiv.org/abs/2606.09225)
...
### [45] [FMplex: Model Virtualization for Serving Extensible Foundation Models](https://arxiv.org/abs/2606.09643)
...
### [46] [Fairness-Aware and Latency-Controllable Scheduling for Chunked-Prefill LLM Serving](https://arxiv.org/abs/2606.09061)
...
### [56] [Chimera: Protocol-Aware Recovery for Confidential BFT Consensus](https://arxiv.org/abs/2606.09101)
...
### [57] [Concepts in Practice: C++ MPI Bindings for the HPC Ecosystem. From a Standardizable Core to a Composable Interface](https://arxiv.org/abs/2606.09102)
...
### [58] [AutoPilot: Learning to Steer High Speed Robust BFT](https://arxiv.org/abs/2606.09120)
...
### [59] [Resource-aware Computation-Communication Overlap for multi-GPU ML Workloads](https://arxiv.org/abs/2606.09200)
...
### [60] [Engineering Scalable Distributed List Ranking](https://arxiv.org/abs/2606.09318)
...
### [61] [Coupling Complementary Simulations for Combined Performance and Energy Optimization](https://arxiv.org/abs/2606.09356)
...
### [62] [Parent-Hash DAG: A Cost Analysis of Constant-Time Append for On-Chain Registries](https://arxiv.org/abs/2606.09593)
...
### [63] [Symbolic Reasoning Frameworks Modulate LLM Risk Aversion in Multi-Agent Strategic Settings](https://arxiv.org/abs/2606.07552)
*Augustin Chan*
...
### [64] [GRPO Does Not Close the Multi-Agent Coordination Gap](https://arxiv.org/abs/2606.07845)
...
### [65] [EduMirror: Modeling Educational Social Dynamics with Value-driven Multi-agent Simulation](https://arxiv.org/abs/2606.07948)
...
### [66] [Voting Protocols as Coordination Mechanisms for Role-Constrained Multi-Agent Tutoring Systems](https://arxiv.org/abs/2606.08030)
...
### [67] [Silent Failure in LLM Agent Systems: The Entropy Principle and the Inevitable Disorder of Autonomous Agents](https://arxiv.org/abs/2606.08162)
*Dexing Liu*
...
### [68] [Toward Human-Centered Multi-Agent Systems: Integrating Cognition, Culture, Values, and Cooperation in AI Agents](https://arxiv.org/abs/2606.08274)
...
### [69] [Emergence World: A Platform for Evaluating Long-Horizon Multi-Agent Autonomy](https://arxiv.org/abs/2606.08367)
...
### [70] [The Consistency Illusion: How Multi-Agent Debate Hides Reasoning Misalignment](https://arxiv.org/abs/2606.08457)
...
### [71] [Is Telehealth Better Used to Treat Patients or Help Other Physicians Treat Patients? An Agent-Based Modeling Study of Healthcare Provision](https://arxiv.org/abs/2606.08701)
*Michael Chary*
...
### [72] [Performance Evaluation of Social Learning](https://arxiv.org/abs/2606.09176)
...
### [73] [Programming Domain-Specific FPGA Hardblocks from HLS: An RTL Blackbox Approach](https://arxiv.org/abs/2606.08380)
...
### [74] [An 84-Format Numeric Catalog with Bit-Exact Conformance Vectors: A Vendor-Neutral Reference for FP8, BF16, MXFP4, and Microscaling Formats](https://arxiv.org/abs/2606.09686)
*Dmitrii Vasilev*
...
### [75] [Accuracy-Configurable Floating-Point Multiplier Design for SRAM-Based Compute-in-Memory](https://arxiv.org/abs/2606.08430)
...
### [76] [PALUTE: Processing-In-Memory Acceleration via Lookup Table for Edge LLM Inference](https://arxiv.org/abs/2606.08891)
...
### [77] [LongRTL: Graph-Similarity-Guided LLM-driven Long Context RTL Optimization](https://arxiv.org/abs/2606.08944)
...
### [78] [NeuDW-CIM: a 65-nm 0.8-pJ/Sop Reconfigurable Neuromorphic Compute-in-Memory Macro with Nonlinear Dendrites and K-Winners](https://arxiv.org/abs/2606.08947)
...
### [79] [A 65-nm Privacy-Preserving Neuromorphic Encoder With 7.13-nJ Efficiency, 2.38-Mb/mm^2 Item-Memory Density, and Federated Learning Support](https://arxiv.org/abs/2606.09460)
