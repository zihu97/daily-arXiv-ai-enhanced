...
### [11] [Energy Calculus: A Compositional Algebra of Energy in Computational Systems](https://arxiv.org/abs/2607.11087)
...
### [12] [A Note on Diameter Certification in Trees](https://arxiv.org/abs/2607.09929)
*Josef Erik Sedláček*
...
### [13] [Decomposing Runtime, Kernel, and Quantization Speedups via a Matched FP16 Intermediate: A Hardware-Conditioned Case Study on Four NVIDIA RTX A5000 GPUs](https://arxiv.org/abs/2607.11368)
*Weijia Han,Lisha Qu*
...
### [14] [Trusted Floors Under Untrusted Learners: A Runtime Assured-SLO Guard for ML Serving](https://arxiv.org/abs/2607.09992)
*Hsiu-Chi Tsai*
...
### [15] [Descriptive Execution of HPC Applications and Workflows](https://arxiv.org/abs/2607.10081)
...
### [16] [Consensus as Collapse Policy: Communication Evidence, Horizons, and Prefix Decisions](https://arxiv.org/abs/2607.10152)
*Tomislav Grospić*
...
### [17] [Automated Tensor Scheduling for Hybrid CPU-GPU LLM Inference on Consumer Devices](https://arxiv.org/abs/2607.10183)
...
### [18] [Byzantine Accountability Without Consensus: Strong Eventual Consistency for Non-Associative, Stochastic, Robust Aggregation](https://arxiv.org/abs/2607.10305)
*Ryan Gillespie*
...
### [19] [Stateful Worlds, Stateless Elasticity: Exact-State Serving for Interactive World Models](https://arxiv.org/abs/2607.10389)
*Jin Li,Jiawei Chen*
...
### [20] [CloudMicroHaskell: Direct-Style Distributed Haskell via Runtime Graph Serialisation](https://arxiv.org/abs/2607.10443)
...
### [21] [Ichnos+: Estimating the Carbon Footprint of Scientific Workflows Using Fitted Power Models](https://arxiv.org/abs/2607.10586)
...
### [22] [[AAFLOW+] Stateful Operator Abstraction with Zero-Copy Distributed KV Cache Orchestration for Multi-Agent Workflows](https://arxiv.org/abs/2607.10987)
...
### [23] [Domain Extension of Lock-Freedom and Wait-Freedom for Group Computations](https://arxiv.org/abs/2607.11014)
...
### [24] [Xema: Efficient Diffusion Serving through Fine-Grained Memory Management and Auto-Configuration](https://arxiv.org/abs/2607.11136)
...
### [25] [GPU-Tile-Sim: A Tile-Centric GPU Simulation Framework for LLM Hardware-Software Co-Design](https://arxiv.org/abs/2607.11262)
...
### [26] [Stage-Level Executor Allocation in Apache Spark with Cost-Performance Trade-offs](https://arxiv.org/abs/2607.11415)
...
### [27] [MemExchange: Cloud-Scale Memory Trading](https://arxiv.org/abs/2607.11579)
...
### [28] [AfterVibe: What Remains When the Conversation Ends](https://arxiv.org/abs/2607.09900)
...
### [29] [Do These Violent Delights Have Violent Ends? Measuring the Post-Merge Fate of Agentic Code](https://arxiv.org/abs/2607.09902)
...
### [30] [Using LLMs to Adjudicate Static-Analysis Alerts with Error Reduction Techniques](https://arxiv.org/abs/2607.09979)
...
### [31] [A Large-Scale Dataset of MCP Implementations on GitHub](https://arxiv.org/abs/2607.10123)
...
### [32] [ML in a Box: Analyzing Containerization Practices in Open Source ML Projects](https://arxiv.org/abs/2607.10126)
...
### [33] [Chain-Aware Encoding for Microservice Trace Anomaly Detection](https://arxiv.org/abs/2607.10156)
...
### [34] [Model-Driven Digital Twin Framework for Quantum Networks](https://arxiv.org/abs/2607.10367)
...
### [35] [VRExplorer: A Model-based Approach for Semi-Automated Testing of Virtual Reality Scenes](https://arxiv.org/abs/2607.10174)
...
### [36] [Which Neurons Detect Malicious Code? A Probing Study of LLM Security Knowledge](https://arxiv.org/abs/2607.10221)
...
### [37] [From Business Requirements to Test Assertions: Evaluating LLM-Generated Oracles on Real Bugs](https://arxiv.org/abs/2607.10277)
...
### [38] [Partial Contracts Suffice: Sound, LLM-Inferred Regression Verification](https://arxiv.org/abs/2607.10291)
...
### [39] [A Framework for Managing the Models of Engineered Quantum Systems](https://arxiv.org/abs/2607.10347)
...
### [40] [Mitigating LLM Sycophancy in Code Smell Detection Using Evidence-Guided Reasoning Prompts](https://arxiv.org/abs/2607.10411)
...
### [41] [Is Model Instability just Noise to be Tolerated or a Property that can be Managed?](https://arxiv.org/abs/2607.10420)
...
### [42] [Toward Production-Ready Federated Learning in Healthcare: Privacy, Orchestration, and Governance in MLOps](https://arxiv.org/abs/2607.10467)
...
### [43] [Trusting AI to increase productivity? Perspectives Across the Global North and South](https://arxiv.org/abs/2607.10488)
...
### [44] [Question Answering for Diagram-Rich Technical Meeting Videos](https://arxiv.org/abs/2607.10494)
...
### [45] [When Does Restricting a Coding Agent to execute_code Help? A Regime $\times$ Agent-Design Ablation](https://arxiv.org/abs/2607.10569)
...
### [46] [WebDesignIter: Co-Evolving Design Knowledge for Repository-Level Front-End Code Generation](https://arxiv.org/abs/2607.10621)
...
### [47] [Commenting with Copilot: A Taxonomy and Multi-Year Analysis of Student Code-Generation Specifications](https://arxiv.org/abs/2607.10674)
...
### [48] [Maintenance and Support in Community-Driven Scientific Pipeline Ecosystems: A Cross-Platform Empirical Study of nf-core](https://arxiv.org/abs/2607.10839)
...
### [49] [How Do Practitioners Build SE Agents? Insights from a Mixed-Methods Study](https://arxiv.org/abs/2607.10856)
...
### [50] [BackendForge: Benchmarking Agentic End-to-End Code Generation with Backend Services](https://arxiv.org/abs/2607.11042)
...
### [51] [Retrieval-Oriented Code Representations in Agentic Bug Localization](https://arxiv.org/abs/2607.11046)
...
### [52] [AgentCheck: A Reproduce-Intervene-Mitigate Workbench for LLM Agents over MCP](https://arxiv.org/abs/2607.11098)
...
### [53] [Know Before Fix: QA-Driven Repository Knowledge Acquisition for Software Issue Resolution](https://arxiv.org/abs/2607.11111)
...
### [54] [RepTran: Search-Based Repair of Transformer Models](https://arxiv.org/abs/2607.11193)
...
### [55] [An Empirical Study for GUI Test Migration from Android to OpenHarmony System](https://arxiv.org/abs/2607.11245)
...
### [56] [Hidden or Formal Architects: Understanding Who Makes Architectural Decisions in Practice](https://arxiv.org/abs/2607.11251)
...
### [57] [Extending Decision Maps for Sustainable Safety and Security in Self-Adaptive Systems](https://arxiv.org/abs/2607.11274)
...
### [58] [FlowArk: Boosting Agentic Data-flow Analysis for Android Apps via Context-Aware Knowledge Reuse](https://arxiv.org/abs/2607.11308)
...
### [59] [Fail-Aware and Explainable Test Oracle Prediction](https://arxiv.org/abs/2607.11342)
...
### [60] [Understanding the Impact of AI Code Assistants on Security API Usage: An Empirical Study](https://arxiv.org/abs/2607.11348)
...
### [61] [Predicting Program Comprehension with Foundation Models of Human Cognition](https://arxiv.org/abs/2607.11372)
...
### [62] [From GUI Tests to Conversational Interaction: A New Perspective on App-Specific Voice Assistants](https://arxiv.org/abs/2607.11387)
...
### [63] [TerraRepair: A Tool-Grounded LLM Agent for Infrastructure-as-Code Repair](https://arxiv.org/abs/2607.11390)
...
### [64] [Knowledge-Guided Synthetic Bug Feedback for LLM-Based Unit Test Generation](https://arxiv.org/abs/2607.11573)
...
### [65] [ThinkLog: Leveraging Reasoning for Log Statement Generation](https://arxiv.org/abs/2607.11615)
...
### [66] [Which Optimizer, At What Budget? A Tournament of Optimizers for Search-Based SE](https://arxiv.org/abs/2607.11705)
...
### [67] [Evaluating RE Practices for Explainability: Synthesizing Insights from Daimler Truck into an Explainable RE Framework Proposal](https://arxiv.org/abs/2607.11771)
...
### [68] [Analyzing Interaction Between CCAs and Traffic Policers](https://arxiv.org/abs/2607.09984)
*Ammar Tahir*
...
### [69] [CSI-Assisted Edge SLAM Testbed Platform for 5G Connected Unmanned Autonomous Vehicles](https://arxiv.org/abs/2607.10394)
...
### [70] [The Emerging 3GPP 6G RAN Architecture: An Overview](https://arxiv.org/abs/2607.10543)
*Xingqin Lin*
...
### [71] [SAIL: Perceptual Quality-Aware Rate Control for Cloud Gaming](https://arxiv.org/abs/2607.11231)
...
### [72] [An Experimental Evaluation of Accurate Scheduling and Hardware Timestamping on NVIDIA ConnectX NICs](https://arxiv.org/abs/2607.11305)
...
### [73] [GNSS Spoofing Detection in TDD Networks: A 3GPP Standards-Based Security Framework](https://arxiv.org/abs/2607.11398)
...
### [74] [Transfer Learning Across Policy Regimes in Adaptive Multi-Agent Systems](https://arxiv.org/abs/2607.09685)
*Roberto Garrone*
...
### [75] [RideGym: A Standardized Interface for Real-World Large-Scale Ride-Sharing System](https://arxiv.org/abs/2607.10173)
...
### [76] [Distributed Agent System: Fault-Tolerant Collaboration Among Embodied Agents](https://arxiv.org/abs/2607.10811)
...
### [77] [Auditing Belief-Conditioned LLM Agents in Hidden-Information Social Deduction Games](https://arxiv.org/abs/2607.10814)
...
### [78] [Multi-Agent LLMs Fail to Explore Each Other](https://arxiv.org/abs/2607.11250)
...
### [79] [An Explainable Agentic System for Detection of Conversational Scams with Summary-Based Memory](https://arxiv.org/abs/2607.11707)
...
### [80] [Multi-Agent Reinforcement Learning for C-V2X RAT Selection](https://arxiv.org/abs/2607.11744)
...
### [81] [Forgetting Our Way to Shared Meaning: Effects of Forgetting on Conceptual Alignment in a Non-Partnership Coordination Game](https://arxiv.org/abs/2607.11787)
