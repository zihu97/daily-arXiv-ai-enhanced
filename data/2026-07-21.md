...
### [16] [SALT: Salience-Aware Lexical Trie for Long-Context Compression](https://arxiv.org/abs/2607.17486)
...
### [17] [On Hardware-Aware Design and Optimization of Edge Intelligence](https://arxiv.org/abs/2607.16297)
...
### [18] [Enabling Spatially Fine-Grained DVFS in Neural Processing Units for Energy-Efficient LLM Serving](https://arxiv.org/abs/2607.16473)
...
### [19] [Cross-Domain Acceleration of Open Modification Search: From Commodity Platforms to Emerging Memory and Storage Devices](https://arxiv.org/abs/2607.17569)
...
### [31] [New Number Formats for FFT IP Cores in Optical OFDM Transceivers](https://arxiv.org/abs/2607.17835)
...
### [32] [SEAM-V: A Hybrid-Decoupled RISC-V Vector Processor with Backend-Visible EP Context for Sustained Vector Throughput](https://arxiv.org/abs/2607.17899)
...
### [33] [Fixed Point Exploration For CV-QKD IR QC-MET-LDPC Toward Hardware Implementation](https://arxiv.org/abs/2607.17960)
...
### [34] [Hardware Mechanisms to Dynamically Throttle AI Performance](https://arxiv.org/abs/2607.18069)
...
### [35] [Automated Hardware Validation Test Plan Generation for Large Scale AI Datacenter Platforms Using a Generative AI Multi-Agents Architecture](https://arxiv.org/abs/2607.16388)
...
### [36] [Laplacian Spectral Shaping for Non-Uniform Scaling Formation Control of Open Multi-Agent Systems](https://arxiv.org/abs/2607.16709)
...
### [37] [When Is Heterogeneous Distance-Decay Facility Location Tractable? A Structural Classification, Exact Methods, and a Real-World Study](https://arxiv.org/abs/2607.16764)
...
### [38] [Auto Research for Materials: Auditable AI-Scientist Workflows with Held-Out Transfer](https://arxiv.org/abs/2607.17100)
...
### [39] [The Optimization Trilemma: Efficiency, Comfort and Fairness in Decentralized Multi-agent Coordination](https://arxiv.org/abs/2607.17311)
...
### [40] [A Digital Twin-Based Method for Evaluating Local Collective Tariffs in Distribution-Level Energy Systems](https://arxiv.org/abs/2607.17640)
...
### [41] [Value-Aware Prediction for Robust Multi-Agent Coordination Under Communication Loss](https://arxiv.org/abs/2607.17914)
...
### [42] [PRIME: Plasticity Recovery in Multi-Agent Environments for UAV-Assisted Emergency Communication Networks](https://arxiv.org/abs/2607.17922)
...
### [43] [Aggregate in the Advantage, Not the Ratio: A Canonical-Form Analysis of Cooperative Multi-Agent Policy Optimization](https://arxiv.org/abs/2607.17924)
*Zijian Zhao,Sen Li*
...
### [44] [AEVAL: From Anecdotal to Deterministic Testing for Agentic Skill Workflows](https://arxiv.org/abs/2607.16345)
...
### [45] [AoA: Theorem Proving Agent over Abstract Syntax Tree of Redesigned Language](https://arxiv.org/abs/2607.16372)
...
### [46] [Fantastic Adaptive Taxonomies and How to Use Them](https://arxiv.org/abs/2607.16387)
...
### [47] [When to Use Which? Benchmarking Optimisers for Configurable Systems under Varying Budgets](https://arxiv.org/abs/2607.16476)
...
### [48] [Personalized Assessments from Personal Artifacts](https://arxiv.org/abs/2607.16494)
...
### [49] [ReqGenX: An Empirical Study of Atomic Decomposition, Artifact Regeneration, and Reconstruction for Legacy SRS Documents](https://arxiv.org/abs/2607.16564)
...
### [50] [From Discussion to Execution: Replicating Buggy and Correct Data Science Code](https://arxiv.org/abs/2607.16569)
...
### [51] [DataFlow-Harness: A Grounded Code-Agent Platform for Constructing Editable LLM Data Pipelines](https://arxiv.org/abs/2607.16617)
...
### [52] [CLOSER-Bench: Evaluating Budgeted Cross-Stage Design Closure for Hardware Agents](https://arxiv.org/abs/2607.16632)
...
### [53] [Falsification-Based Verification of LLM-Generated Optimization Models: Sound Test Batteries and Their Detection Limits](https://arxiv.org/abs/2607.16646)
*Haifeng Li,Mo Hai*
...
### [54] [How Do You Choose Your AI Component? An Interview Study of Secure AI Integration in Practice](https://arxiv.org/abs/2607.16660)
...
### [55] [Specification-Driven Development as the Foundation of AI-Native Enterprise Software Engineering](https://arxiv.org/abs/2607.16680)
*Mamdouh Alenezi*
...
### [56] [Beyond Visibility and Technical Reuse: Public Application Transformation in Open-Source Model Ecosystems](https://arxiv.org/abs/2607.16687)
...
### [57] [Dependency-Guided Code Generation: Structured Matrix Decomposition and Consistency-Guided Refinement](https://arxiv.org/abs/2607.16692)
...
### [58] [Model-Driven Discipline for Multi-Agent LLMs: Requirement-to-Verification Generation of Traceable System Models](https://arxiv.org/abs/2607.16708)
...
### [59] [Agentic Code Review in the Terminal: A Trajectory-Level Analysis of Behavior, Cost, and Human-Alignment](https://arxiv.org/abs/2607.16740)
...
### [60] [A Preliminary Study on the Impact of AI in the Creativity and Collaboration in Software Teams](https://arxiv.org/abs/2607.16744)
...
### [61] [A Non-Intrusive Traffic Analysis Framework for Authorization Risk Detection and Coordinated Response in Web Applications](https://arxiv.org/abs/2607.16754)
...
### [62] [When Post-Anchor Metrics Fail: Stabilization Regimes in AI-Evidence Open-Source Projects](https://arxiv.org/abs/2607.16979)
...
### [63] [MechMem-RTL: Reusing Verified Mechanism Memories for LLM-Based RTL Repair](https://arxiv.org/abs/2607.17053)
...
### [64] [Schema-Bound LLM Control of Scientific Instrumentation through Model Context Protocol Skills](https://arxiv.org/abs/2607.17012)
...
### [65] [Can LLM Code Explanations Adapt to Diverse Problem-Solvers' Needs?](https://arxiv.org/abs/2607.17022)
...
### [66] [Where Does Agent Reliability Come From? A Cross-Benchmark Decomposition of Verification Loops, Specialist Models, and Scaffolding in a Production Enterprise Agent](https://arxiv.org/abs/2607.17044)
*Arunabh Dastidar*
...
### [67] [Teach it to stop, not just to click](https://arxiv.org/abs/2607.17136)
...
### [68] [SynH-Rank: Quality-Aware Code Search via Diverse Data Synthesis and Hierarchical Ranking Training](https://arxiv.org/abs/2607.17139)
...
### [69] [Prefactory: Automated Discovery and Application of Library-Adoption Refactorings](https://arxiv.org/abs/2607.17211)
...
### [70] [Specifying the Delegated-Autonomy Boundary: Requirements Engineering for Agentic AI](https://arxiv.org/abs/2607.17225)
...
### [71] [A RFID Based Campus Wide Payment System](https://arxiv.org/abs/2607.17233)
...
### [72] [A Large-Scale Measurement of AI Bill of Materials Completeness in Hugging Face Models](https://arxiv.org/abs/2607.17242)
...
### [73] [IssueExec: A Test-Driven Approach for Localizing Software Engineering Issues](https://arxiv.org/abs/2607.17286)
...
### [74] [Portable models as a replacement for industrial heuristics in compiler optimizations](https://arxiv.org/abs/2607.17389)
...
### [75] [Combining model checking with simulation-based techniques for protocol verification](https://arxiv.org/abs/2607.17453)
...
### [76] [PSASpotter: A Tool to Detect the Usage of Platform-Specific APIs in Python](https://arxiv.org/abs/2607.17462)
...
### [77] [CommitLLM: A Fine-Tuned Pipeline for Git Commit Message Generation](https://arxiv.org/abs/2607.17532)
...
### [78] [BTOR2-Based C Program Verification via Hardware Model Checking](https://arxiv.org/abs/2607.17622)
...
### [79] [Integrating High-Level Requirements to Low-Level Tests with Machine-Readable V&V Specifications](https://arxiv.org/abs/2607.17686)
...
### [80] [KernelDiag: Agent-Based Root Cause Diagnosis for Kernel Crashes](https://arxiv.org/abs/2607.17722)
...
### [81] [Persona-as-Configuration: Generative Stakeholder Reporting for Agricultural Floods](https://arxiv.org/abs/2607.17774)
...
### [82] [(Over)Reliance on Test Agents in AI-Assisted Software Testing](https://arxiv.org/abs/2607.17927)
*Eduard Paul Enoiu*
...
### [83] [How Agent Skills Fail under Long Contexts: A White-Box Study in Code Auditing](https://arxiv.org/abs/2607.17937)
*Yue Xue*
...
### [84] [DepRepair: LLM-Based Source-Code Repair for Dependency Breaking Changes](https://arxiv.org/abs/2607.17957)
...
### [85] [Chiral Analysis of Smart Contracts: Detecting Vulnerabilities from Relational Inconsistencies Across Business Paths](https://arxiv.org/abs/2607.17987)
*Yue Xue*
...
### [86] [Test Coverage Analysis of Agentic Pull Requests](https://arxiv.org/abs/2607.18057)
...
### [87] [Autoresearch with Coding Agents: Generalizers and Metric-Maximizers on Quran Recitation Data](https://arxiv.org/abs/2607.18064)
...
### [88] [Testing Retrieval-Augmented Generation Systems with Chunk Coverage](https://arxiv.org/abs/2607.18155)
...
### [89] [TRIM: Reducing AI-Generated CodeSlop via Agent Trajectory Minimization](https://arxiv.org/abs/2607.18161)
...
### [90] [AirMoE: Statistic-Augmented Over-the-Air MoE for Collaborative Intelligence](https://arxiv.org/abs/2607.16562)
...
### [91] [Wait-Free Locks Should Not Fear Later Arrivals](https://arxiv.org/abs/2607.16571)
*Tong Che*
...
### [92] [Hardware-Transparent I/O Governance in Disaggregated Heterogeneous Storage](https://arxiv.org/abs/2607.16578)
...
### [93] [Cold-Start Model Delivery in Kubernetes Inference Serving: An Empirical Study of OCI-Based Distribution and Its Integrity](https://arxiv.org/abs/2607.16596)
*Georgii Kliukovkin*
...
### [94] [Roomie: Interference-Aware Colocation for Efficient Model Serving](https://arxiv.org/abs/2607.16784)
...
### [95] [Technical Report: AI-Assisted Gated DeltaNet Optimization on NVIDIA Blackwell](https://arxiv.org/abs/2607.16831)
...
### [96] [Beyond Storage: State as a Runtime Control Problem in Parallel and Distributed Systems](https://arxiv.org/abs/2607.16836)
...
### [97] [EdgeCoInfer: Hierarchical Collaborative Inference for On-Device Multimodal Large Models](https://arxiv.org/abs/2607.17143)
...
### [98] [LMEdge: QoS-Aware LLM Inference Orchestration on Edge Clusters](https://arxiv.org/abs/2607.17175)
...
### [99] [Talaria: Session-Aware Serverless Serving of Hundred-Billion-Parameter LLMs](https://arxiv.org/abs/2607.17181)
...
### [100] [Taurus: Accelerating Out-of-Core Graph Neural Network Inference on Billion-Scale Graphs](https://arxiv.org/abs/2607.17374)
...
### [101] [A Training-Memory Regression in MLA Sequence Parallelism: Why Megatron-Core Forbids Absorption, and LAGA -- a Communication-Efficient Fix](https://arxiv.org/abs/2607.17644)
*Changzheng Ma*
...
### [102] [Byzantine Fault-Tolerant Post-Quantum Distributed Quorum Signatures](https://arxiv.org/abs/2607.17700)
...
### [103] [AutoEncoder-Compressed Parallel Split Learning for Pre-trained Model Fine-Tuning](https://arxiv.org/abs/2607.17913)
...
### [104] [ExpertPlex: A High-Goodput Disaggregated Serving System for MoE LLMs with Adaptive Persistent Kernels](https://arxiv.org/abs/2607.18002)
...
### [105] [HyMCache: A KV Cache Framework for Multi-Turn LLM Serving with CXL-Hybrid Memory](https://arxiv.org/abs/2607.18141)
...
### [106] [uSTM: A Lightweight and Efficient STM Supporting General Types and Deferred Aborts](https://arxiv.org/abs/2607.18178)
...
### [107] [Rethinking Polling Efficiency in Service Core Network Stacks](https://arxiv.org/abs/2607.16408)
...
### [108] [SuperPass: Fast-Tracking Blocking Threads to Mitigate Priority Inversion on Mobile Devices](https://arxiv.org/abs/2607.18097)
