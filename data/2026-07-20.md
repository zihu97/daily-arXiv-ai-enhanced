...
### [4] [RTL-Sequencer: Towards Scalable RTL Timing Prediction with the Sequence-based Paradigm](https://arxiv.org/abs/2607.15830)
...
### [5] [DSTAR: Accelerating Diffusion Transformers via Spatial and Temporal Redundancy Reduction](https://arxiv.org/abs/2607.15846)
...
### [6] [From Patterns to Parsers: Automatic Generation of Efficient Hardware Parsers for FPGAs](https://arxiv.org/abs/2607.16058)
...
### [8] [Split-Aware Function Placement with Availability Guarantees and Optical Provisioning in vRANs](https://arxiv.org/abs/2607.15816)
...
### [9] [App-Based Performance Characterization of Cellular and Wi-Fi Networks in Dense Stadium Deployments](https://arxiv.org/abs/2607.16008)
...
### [10] [LLM-Powered Agentic AI for 5G/6G Networks: A Tutorial and Survey on Architectures, Protocols, and Standardization](https://arxiv.org/abs/2607.16066)
...
### [11] [FSZ: Breaking the Prediction-Throughput Trade-off in GPU Lossy Compression](https://arxiv.org/abs/2607.15413)
*Jiajun Huang*
...
### [12] [Scalable LLM Agent Tool Access in the Cloud](https://arxiv.org/abs/2607.15593)
...
### [13] [JoyNexus: Service-Oriented Multi-Tenant Post-Training for VLA Models](https://arxiv.org/abs/2607.16074)
...
### [14] [Every Microsecond Matters: Achieving Near Speed-of-Light Latency in GPU Collectives](https://arxiv.org/abs/2607.16100)
...
### [15] [CHRONO-RESOLUTION: A Dependency Resolution Dataset at Release Points for npm, PyPI, and crates.io Packages](https://arxiv.org/abs/2607.15315)
...
### [16] [Two-Path Status Verification for Outbound Enterprise Messaging Pipelines: Webhook and Scheduled Polling Fallback Architecture](https://arxiv.org/abs/2607.15529)
*Devam Gupta*
...
### [17] [Understanding Agent-Reactive Bugs at the Model-Harness Boundary: An Empirical Study of LLM Agent Issue Reports](https://arxiv.org/abs/2607.15684)
...
### [18] [Verified LLM-Driven Synthesis for Concept Design](https://arxiv.org/abs/2607.15718)
*Alcino Cunha*
...
### [19] [GapForge: Directed Compiler Fuzzing via Coverage-Gap Analysis](https://arxiv.org/abs/2607.15762)
...
### [20] [Making Agent-Mediated Contributions Governable: A Project-Level Governance Manifest for Open-Source AI Collaboration](https://arxiv.org/abs/2607.15769)
...
### [21] [READU: Inconsistency-Driven Just-in-Time Detection and Repair of README Bugs](https://arxiv.org/abs/2607.15780)
...
### [22] [In the Driver's Seat: A Multi-Company Study on the Reality of Autonomous Driving System Testing](https://arxiv.org/abs/2607.15820)
...
### [23] [Agentic Synthesis against Counterexample-Supplemented Sketches](https://arxiv.org/abs/2607.15854)
...
### [24] [Trans-Domain Digital Twin: Conceptual Foundations, Architecture, and Research Outlook](https://arxiv.org/abs/2607.15908)
*Mansoorali Amiri*
...
### [25] [TARS: A Theory-of-Mind Agent for Personalized In-IDE Code Comprehension](https://arxiv.org/abs/2607.15948)
...
### [26] [DiffTestGen: Change-Directed LLM-Based Testing for Exposing Behavioral Differences](https://arxiv.org/abs/2607.16024)
...
### [27] [What Does It Take to Research with AI? A Rapid Review of Competencies to Train LLM-Literate Researchers](https://arxiv.org/abs/2607.16083)
...
### [28] [Comparison of Energy System Optimization Software and Evaluation of Selected Frameworks](https://arxiv.org/abs/2607.16121)
