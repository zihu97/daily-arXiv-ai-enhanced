...
### [11] [Gecko: A Simulation Environment with Stateful Feedback for Refining Agent Tool Calls](https://arxiv.org/abs/2602.19218)
...
### [12] [Operational Robustness of LLMs on Code Generation](https://arxiv.org/abs/2602.18800)
...
### [13] [From Docs to Descriptions: Smell-Aware Evaluation of MCP Server Descriptions](https://arxiv.org/abs/2602.18914)
...
### [14] [Narrowing the Complexity Gap in the Evaluation of Large Language Models](https://arxiv.org/abs/2602.18928)
...
### [15] [A Systematic Evaluation of Environmental Flakiness in JavaScript Tests](https://arxiv.org/abs/2602.19098)
...
### [28] [Evolution of fairness in hybrid populations with specialised AI agents](https://arxiv.org/abs/2602.18498)
...
### [29] [NutriOrion: A Hierarchical Multi-Agent Framework for Personalized Nutrition Intervention Grounded in Clinical Guidelines](https://arxiv.org/abs/2602.18650)
...
### [30] [When Coordination Is Avoidable: A Monotonicity Analysis of Organizational Tasks](https://arxiv.org/abs/2602.18673)
*Harang Ju*
...
### [31] [EDU-MATRIX: A Society-Centric Generative Cognitive Digital Twin Architecture for Secondary Education](https://arxiv.org/abs/2602.18705)
...
### [32] [Adaptive Collaboration of Arena-Based Argumentative LLMs for Explainable and Contestable Legal Reasoning](https://arxiv.org/abs/2602.18916)
...
### [33] [A potentialization algorithm for games with applications to multi-agent learning in repeated games](https://arxiv.org/abs/2602.18925)
...
### [34] [Scaling Inference-Time Computation via Opponent Simulation: Enabling Online Strategic Adaptation in Repeated Negotiation](https://arxiv.org/abs/2602.19309)
...
### [35] [City Editing: Hierarchical Agentic Execution for Dependency-Aware Urban Geospatial Modification](https://arxiv.org/abs/2602.19326)
...
### [36] [Effects of Property Recovery Incentives and Social Interaction on Self-Evacuation Decisions in Natural Disasters: An Agent-Based Modelling Approach](https://arxiv.org/abs/2602.19639)
...
### [37] [Descent-Guided Policy Gradient for Scalable Cooperative Multi-Agent Learning](https://arxiv.org/abs/2602.20078)
*Shan Yang,Yang Liu*
...
### [38] [On the Inherent Resilience of Task-Oriented V2X Networks to Content-Selection Errors](https://arxiv.org/abs/2602.18620)
...
### [39] [Federated Learning-Assisted Optimization of Mobile Transmission with Digital Twins](https://arxiv.org/abs/2602.18627)
...
### [40] [MetaBlue: A Metasurface-Assisted Acoustic Underwater Localization System](https://arxiv.org/abs/2602.19252)
...
### [41] [EMS-FL: Federated Tuning of Mixture-of-Experts in Satellite-Terrestrial Networks via Expert-Driven Model Splitting](https://arxiv.org/abs/2602.19485)
...
### [42] [Spritz: Path-Aware Load Balancing in Low-Diameter Networks](https://arxiv.org/abs/2602.19567)
...
### [43] [Traffic-Aware Configuration of OPC UA PubSub in Industrial Automation Networks](https://arxiv.org/abs/2602.19603)
...
### [44] [AI-Powered Conflict Management in Open RAN: Detection, Classification, and Mitigation](https://arxiv.org/abs/2602.19758)
...
### [45] [BeamVLM for Low-altitude Economy: Generative Beam Prediction via Vision-language Models](https://arxiv.org/abs/2602.19929)
...
### [46] [Adaptive Underwater Acoustic Communications with Limited Feedback: An AoI-Aware Hierarchical Bandit Approach](https://arxiv.org/abs/2602.20105)
...
### [47] [The Category Mistake of Cislunar Time: Why NASA Cannot Synchronize What Doesn't Exist](https://arxiv.org/abs/2602.18641)
*Paul Borrill*
...
### [48] [Why iCloud Fails: The Category Mistake of Cloud Synchronization](https://arxiv.org/abs/2602.19433)
*Paul Borrill*
...
### [49] [What Distributed Computing Got Wrong: The Category Mistake That Turned Design Choices into Laws of Nature](https://arxiv.org/abs/2602.18723)
*Paul Borrill*
...
### [50] [BiScale: Energy-Efficient Disaggregated LLM Serving via Phase-Aware Placement and DVFS](https://arxiv.org/abs/2602.18755)
...
### [51] [Carbon-aware decentralized dynamic task offloading in MIMO-MEC networks via multi-agent reinforcement learning](https://arxiv.org/abs/2602.18797)
...
### [52] [WANSpec: Leveraging Global Compute Capacity for LLM Inference](https://arxiv.org/abs/2602.18931)
...
### [53] [ucTrace: A Multi-Layer Profiling Tool for UCX-driven Communication](https://arxiv.org/abs/2602.19084)
...
### [54] [A Formal Framework for Predicting Distributed System Performance under Faults](https://arxiv.org/abs/2602.19088)
...
### [55] [Asymptotic Subspace Consensus in Dynamic Networks](https://arxiv.org/abs/2602.19121)
...
### [56] [Semantic Conflict Model for Collaborative Data Structures](https://arxiv.org/abs/2602.19231)
...
### [57] [Complex Event Processing in the Edge: A Combined Optimization Approach for Data and Code Placement](https://arxiv.org/abs/2602.19338)
...
### [58] [GPU-Resident Gaussian Process Regression Leveraging Asynchronous Tasks with HPX](https://arxiv.org/abs/2602.19683)
...
### [59] [A Risk-Aware UAV-Edge Service Framework for Wildfire Monitoring and Emergency Response](https://arxiv.org/abs/2602.19742)
...
### [60] [Linear Reservoir: A Diagonalization-Based Optimization](https://arxiv.org/abs/2602.19802)
...
### [61] [Mitigating Artifacts in Pre-quantization Based Scientific Data Compressors with Quantization-aware Interpolation](https://arxiv.org/abs/2602.20097)
...
### [62] [RPU -- A Reasoning Processing Unit](https://arxiv.org/abs/2602.18568)
...
### [63] [HillInfer: Efficient Long-Context LLM Inference on the Edge with Hierarchical KV Eviction using SmartSSD](https://arxiv.org/abs/2602.18750)
...
### [64] [A Logic-Reuse Approach to Nibble-based Multiplier Design for Low Power Vector Computing](https://arxiv.org/abs/2602.19007)
...
### [65] [pHNSW: PCA-Based Filtering to Accelerate HNSW Approximate Nearest Neighbor Search](https://arxiv.org/abs/2602.19242)
...
### [66] [CORVET: A CORDIC-Powered, Resource-Frugal Mixed-Precision Vector Processing Engine for High-Throughput AIoT applications](https://arxiv.org/abs/2602.19268)
...
### [67] [Closed-Loop Environmental Control System on Embedded Systems](https://arxiv.org/abs/2602.19305)
...
### [68] [Interconnect-Aware Logic Resynthesis for Multi-Die FPGAs](https://arxiv.org/abs/2602.19720)
...
### [69] [Extending CPU-less parallel execution of lambda calculus in digital logic with lists and arithmetic](https://arxiv.org/abs/2602.19884)
