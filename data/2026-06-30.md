...
### [29] [Formation of Circular Directed Networks with Shared Link Costs](https://arxiv.org/abs/2606.28382)
...
### [30] [Is Lying an Emergent Behaviour in LLMs? Evidence from Gaslighting AI agents in a Sustainability Game](https://arxiv.org/abs/2606.28456)
...
### [31] [A Fast Convergent Algorithm for Solving Non-convex Partially-Decoupled Generalized Nash Equilibrium Problems](https://arxiv.org/abs/2606.28617)
...
### [32] [When Latent Agents Lie: KV-Cache Integrity in Multi-Agent LLM Collaboration](https://arxiv.org/abs/2606.28958)
...
### [33] [Metric Aggregation Divergence: A Hidden Validity Threat in Agent-Based Policy Optimization and a Contractual Remedy](https://arxiv.org/abs/2606.29038)
...
### [34] [Minority Sentinel: When to Overturn Majority Voting in Multi-Agent LLM Debates](https://arxiv.org/abs/2606.29270)
...
### [35] [ECHO: Learning Epistemically Adaptive Language Agents with Turn-Level Credit](https://arxiv.org/abs/2606.29745)
...
### [36] [Sparse Sensor Placement in Multi-Agent Reinforcement Learning Control of Rayleigh-Bénard Convection](https://arxiv.org/abs/2606.30238)
...
### [37] [TACO: Tool-Augmented Credit Optimization for Agentic Tool Use](https://arxiv.org/abs/2606.30251)
...
### [38] [Always-OnAgents:A Survey of Persistent Memory, State, and Governance in LLMAgents](https://arxiv.org/abs/2606.30306)
...
### [39] [Translating Natural Language to Strategic Temporal Specifications via LLMs](https://arxiv.org/abs/2606.30441)
...
### [40] [MAS-Lab: A Specification-Driven Validation Framework for Reliable Multi-Agent Systems](https://arxiv.org/abs/2606.30546)
...
### [41] [Evidence-Driven LLM Agent for C-to-Synthesizable-C Conversion and Verification](https://arxiv.org/abs/2606.28409)
...
### [42] [SHIFT: Dynamic Compute Relocation Framework for Communication-Aware Chiplet-Based Systems](https://arxiv.org/abs/2606.28754)
...
### [43] [Harvesting AI Computation at the Edge via Generic Approximation](https://arxiv.org/abs/2606.29518)
...
### [44] [HBM Is Not All You Need: Efficient Disaggregated LLM Serving across Memory-heterogeneous Accelerators](https://arxiv.org/abs/2606.29986)
...
### [45] [Mega: A 22 nm Convolutional Spiking Neural Network Accelerator Achieving 0.375 pJ/SOP for Efficient Edge Vision](https://arxiv.org/abs/2606.30039)
...
### [46] [RQP: Resource-Oriented Quantiser Pruning for Neural Networks on FPGAs](https://arxiv.org/abs/2606.30382)
...
### [47] [COSM: A Cooperative Scheduling Framework for Concurrent PIM and CPU Execution on Mobile Devices](https://arxiv.org/abs/2606.30553)
...
### [48] [Multi-Agent DRL for QoS and Energy Optimization in RIS-Enabled Open-RAN Industrial 6G TN/NTN Networks](https://arxiv.org/abs/2606.28339)
...
### [49] [Latency Components in 5G for Edge Application Discovery and Proximity Services: Targets, Measurements, and Practical Working Points](https://arxiv.org/abs/2606.28341)
*David Rico Menéndez*
...
### [50] [Operating Regimes of Decentralized Learning Under Mobility and Bandwidth Constraints](https://arxiv.org/abs/2606.28342)
...
### [51] [Intent-Driven 6G Service Orchestration: Grounded Translation, Validation, and Decomposition](https://arxiv.org/abs/2606.28348)
...
### [52] [CornerCase: Automated Extremal Testing of Protocol Implementations using LLMs](https://arxiv.org/abs/2606.29124)
...
### [53] [Stateless Network-Aware Adaptive Bitrate Streaming over IPFS](https://arxiv.org/abs/2606.29574)
...
### [54] [Cooperative RSU Sleep Scheduling for Green V2I Corridors](https://arxiv.org/abs/2606.29609)
*Yousef AlSaqabi*
...
### [55] [Scalable Intention Sharing for ETSI VAMs](https://arxiv.org/abs/2606.30034)
...
### [56] [Selective Deployment of Bidirectional Hollow-Core Fibers in Hybrid SMF/HCF Optical Networks](https://arxiv.org/abs/2606.30260)
...
### [57] [LLMs and Optical Networks: A Symbiotic Relationship](https://arxiv.org/abs/2606.30278)
...
### [58] [COHORT: Collaborative Orchestration for Hardening via Offensive Replay on Emulated Topologies](https://arxiv.org/abs/2606.30479)
...
### [59] [SubEdge: A Subscriber-Centric Edge Computing Subsystem in 6G Networks for AI](https://arxiv.org/abs/2606.30554)
...
### [60] [Wireless Backdoor Attack and Defense for Semantic Communications over Multiple Access Channel](https://arxiv.org/abs/2606.30595)
...
### [61] [KernelSight-LM: A Kernel-Level LLM Inference Simulator](https://arxiv.org/abs/2606.28565)
...
### [62] [Concurrent Splay-Based Tree](https://arxiv.org/abs/2606.28889)
...
### [63] [Five Ways to Build a Concurrent Linked From Coarse-Grain Locking to Lock-Free Algorithms](https://arxiv.org/abs/2606.28972)
...
### [64] [Are There Manufacturer Differences in Hard-Drive Reliability?](https://arxiv.org/abs/2606.29078)
...
### [65] [Importance-Aware Resource Allocation for Collaborative Task-Oriented Semantic Communication](https://arxiv.org/abs/2606.29052)
...
### [66] [FBench: A Flexible Benchmark for CFG-Based What-If Exploration of HPC I/O Patterns](https://arxiv.org/abs/2606.30197)
...
### [67] [KernelFlume: Elastic Core-Attention Scaling for Agentic Long-Context Decoding](https://arxiv.org/abs/2606.29207)
...
### [68] [Fog Computing and Large Language Models: A vision for the mutual beneficiaries](https://arxiv.org/abs/2606.29483)
...
### [69] [Energy-Efficient Multimodal Inference Serving with Tri-serve](https://arxiv.org/abs/2606.29629)
...
### [70] [NI-ORCA: A Parallel Algorithm for Counting the Orbits of Non-Induced Graphlets up to K4](https://arxiv.org/abs/2606.29651)
...
### [71] [Demystifying the Design Space and Best Practices for Heterogeneous LLM Inference and Serving](https://arxiv.org/abs/2606.29708)
...
### [72] [SMART-MIG: A Learning Framework for Scalable and Energy-Efficient GPU Scheduling](https://arxiv.org/abs/2606.29775)
...
### [73] [Beyond Uniform Experts: Cost-Aware Expert Execution for Efficient Multi-Device MoE Inference](https://arxiv.org/abs/2606.29982)
...
### [74] [Energy-Aware Scheduling for Serverless LLM Serving on Shared GPUs](https://arxiv.org/abs/2606.30391)
...
### [75] [Analyzing Linearizability in Relativistic Distributed Systems](https://arxiv.org/abs/2606.30419)
...
### [76] [GPU Parallelization Strategies for Forward and Backward Propagation in Shallow Neural Networks: A CUDA-Based Comparative Study](https://arxiv.org/abs/2606.30497)
...
### [77] [Spandana: Reconciling Strict SLOs with Low Cost under Fine-Grained Load Fluctuations](https://arxiv.org/abs/2606.30533)
...
### [78] [Data Replication Meets Function Scheduling in the Edge-Cloud Continuum](https://arxiv.org/abs/2606.30563)
