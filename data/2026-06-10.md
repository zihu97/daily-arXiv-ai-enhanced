...
### [6] [Hardware-accelerated Aggregation: Unification and Specialization](https://arxiv.org/abs/2606.10030)
...
### [7] [RATrain: A Resource-Aware Training Runtime for Large Language Models on Bandwidth-Constrained Heterogeneous Supercomputing Platforms](https://arxiv.org/abs/2606.10415)
...
### [8] [ASTRA-sim 3.0: Next-Level Distributed Machine Learning Simulations via High-Fidelity GPU and Infrastructure Modeling](https://arxiv.org/abs/2606.10440)
...
### [9] [Achieving Cloud-Grade SLOs for Local Mixture-of-Experts Inference through CPU-GPU Hybrid Design](https://arxiv.org/abs/2606.10493)
...
### [10] [Generalizing LCL Complexity Gaps to Unbounded Degree via Monadic Second-Order Properties](https://arxiv.org/abs/2606.10693)
*Chiara Piombi*
...
### [11] [Dynamic Software Updates using CRDTs](https://arxiv.org/abs/2606.10920)
...
### [12] [FairWave : A Fairness-Aware Asynchronous DAG-BFT Consensus](https://arxiv.org/abs/2606.10982)
*Syariful Mujaddiq*
...
### [13] [A Neurosymbolic Prolog Skill for LLM-Driven Service Placement](https://arxiv.org/abs/2606.11113)
...
### [14] [Revisiting "Cooler is Better": ITD-Aware Per-CPU Thermal Optimization for Sustainable Data Center Operation](https://arxiv.org/abs/2606.11163)
...
### [15] [Piper: A Programmable Distributed Training System](https://arxiv.org/abs/2606.11169)
...
### [16] [Anomaly Detection and Root Cause Analysis for Microservice Systems](https://arxiv.org/abs/2606.09942)
*Luan Pham*
...
### [17] [Multi-task LLMs for Bug Classification: Efficient Inference with Auxiliary Decoding Heads](https://arxiv.org/abs/2606.09956)
*Nikolai Rozanov*
...
### [18] [Data-aware Static Analysis: Improving Detection of Semantic Faults in Machine Learning Code Using Data Characteristics](https://arxiv.org/abs/2606.09957)
...
### [19] [What makes a harness a harness: necessary and sufficient conditions for an agent harness](https://arxiv.org/abs/2606.10106)
...
### [20] [TestMap: Evidence Infrastructure for Foundation-Model-Assisted Test Generation](https://arxiv.org/abs/2606.10211)
...
### [21] [From Awareness to Action: How Developers Engage with Accessibility Innovation in LLM-Assisted Development](https://arxiv.org/abs/2606.10311)
...
### [22] [Communication Skills in Software Engineering: A Multivocal Review](https://arxiv.org/abs/2606.10320)
...
### [23] [Beyond Coverage and Kill Scores: Empirically Measuring Test Suite Behavioural Gaps](https://arxiv.org/abs/2606.10417)
...
### [24] [MASTOR: A Multi-Agent Approach to Semantic Test Oracle Generation for RESTful APIs](https://arxiv.org/abs/2606.10465)
...
### [25] [Exploring and Complementing End Users' Requirements in IoT enabled System](https://arxiv.org/abs/2606.10598)
...
### [26] [Watts and Debts of Agentic Frameworks: An Empirical Study (Registered Report)](https://arxiv.org/abs/2606.10702)
...
### [27] [DeNovoSWE: Scaling Long-Horizon Environments for Generating Entire Repositories from Scratch](https://arxiv.org/abs/2606.10728)
...
### [28] [Modular2Simple: A Tool for Modular Scenario Creation Based on the OpenSCENARIO Format](https://arxiv.org/abs/2606.10851)
...
### [29] [From Perception to Action: Can UI Interventions Foster Sustainable LLM Chatbot](https://arxiv.org/abs/2606.10861)
...
### [30] [Writing Better Software Explanations: A Guideline-Based Approach](https://arxiv.org/abs/2606.10880)
...
### [31] [From Quality Properties to Practice: A Guideline and Workflow for Explainability Requirements](https://arxiv.org/abs/2606.10882)
...
### [32] [Early Comparative Evaluation of Transformer Models for Multilingual Software Vulnerability Detection](https://arxiv.org/abs/2606.10925)
...
### [33] [GapFuzz: Cross-Plane Divergence Fuzzing for Distributed SDN Controllers](https://arxiv.org/abs/2606.11035)
...
### [34] [Making Software Meaningful](https://arxiv.org/abs/2606.11051)
...
### [35] [Operationalizing Property-Based Testing for Data-Intensive Scalable Computing Systems](https://arxiv.org/abs/2606.11132)
...
### [36] [Failure Modes of Deep Multi-Agent RL in Asynchronous Pricing: Reproducible Triggers, Trace Diagnostics, and a Partial Fix](https://arxiv.org/abs/2606.09884)
...
### [37] [Decoupling Thought from Speech: Knowledge-Grounded Counterfactual Reasoning for Resilient Multi-Agent Argumentation](https://arxiv.org/abs/2606.10475)
...
### [38] [SkillAxe: Sharpening LLM-Authored Agent Skills Through Evaluation-Guided Self-Refinement](https://arxiv.org/abs/2606.10546)
...
### [39] [Decentralized Multi-Agent Systems with Shared Context](https://arxiv.org/abs/2606.10662)
...
### [40] [LLM-Mediated Demand Response Coordination in Smart Microgrids](https://arxiv.org/abs/2606.11050)
...
### [41] [EstRTL: Functional Estimation Guided RTL Code Generation](https://arxiv.org/abs/2606.09867)
...
### [42] [Toward a Small ML Runtime Stack for Raspberry Pi 5 QPUs](https://arxiv.org/abs/2606.09905)
...
### [43] [ARTA: Adaptive Reinforcement-Learning-Based Throttling Agent for RowHammer Vulnerabilities](https://arxiv.org/abs/2606.09915)
...
### [44] [SPARX: Secure and Privacy-Aware Approximate CNN Acceleration with Edge RISC-V SoC](https://arxiv.org/abs/2606.09946)
...
### [45] [Toward Intelligent Prefetching: A Survey on Complex Memory Access Prediction Techniques](https://arxiv.org/abs/2606.09955)
...
### [46] [A Generic Modulo-$(2^n\pmδ)$ RNS Multiplier Based on Twit Representation](https://arxiv.org/abs/2606.09965)
...
### [47] [Fault Characterization and Hardening of Combinational Standard Cells Using 3D-TCAD Simulations for Cyber-Physical Systems](https://arxiv.org/abs/2606.10015)
...
### [48] [Isolation-aware Scheduling Framework for DNN-based End-to-End Autonomous Driving System on Tile-based Accelerators](https://arxiv.org/abs/2606.10303)
...
### [49] [A 185 TOPS/W/mm2 Bayesian Inference Engine with 640 aJ Write-Free FeFET GRNG for Uncertainty-Aware Aerial Search and Rescue](https://arxiv.org/abs/2606.10822)
...
### [50] [Arithmetic Packing on Wide Integer Datapaths in DSP Primitives of Modern FPGA Devices](https://arxiv.org/abs/2606.11065)
...
### [51] [Coset Ensemble Decoder for Quantum Error Correction with Algorithm-Hardware Co-Design](https://arxiv.org/abs/2606.11076)
...
### [52] [Towards Autonomous Accelerator Design: FPGA Accelerator Generation with SECDA](https://arxiv.org/abs/2606.11117)
...
### [53] [Defeat the Heap: Zero-Copy Data Movement in AXI4MLIR](https://arxiv.org/abs/2606.11158)
