...
### [6] [The Price of Anarchy in Disaggregated Inference](https://arxiv.org/abs/2606.17081)
*Athos Georgiou*
...
### [7] [Surveying GenAI-based Automation in Printed Circuit Board Design and Test](https://arxiv.org/abs/2606.17074)
...
### [17] [RATIO: Redundancy-Controlled Stochastic Routing for Reliable Vehicular Multi-Hop Networking](https://arxiv.org/abs/2606.17481)
*Lei Lei,Xudong Wang*
...
### [18] [Predictive Configured Grant Scheduling for Deterministic Wireless Communications](https://arxiv.org/abs/2606.17653)
...
### [19] [5G Network Architecture and Configuration Choices to Support Teleoperated Driving at Scale](https://arxiv.org/abs/2606.17654)
...
### [20] [Integration of 5G and Industrial Digital Models: A Case Study with AGVs](https://arxiv.org/abs/2606.17655)
...
### [21] [DPDS: A DPDK-Based Packet Delayer and Spacer](https://arxiv.org/abs/2606.17716)
...
### [22] [FlowCLIP: Contrastive Pretraining Using Domain Names for Encrypted Traffic Classification](https://arxiv.org/abs/2606.17746)
*Eun Hun Choi*
...
### [23] [UAV-CAS: A Calibrated Digital-Twin Dataset for Intrusion Detection in UAV Swarm Networks](https://arxiv.org/abs/2606.17845)
...
### [24] [Security-Induced Braess Paradoxes in Service Function Chain Orchestration](https://arxiv.org/abs/2606.17987)
...
### [25] [A T-API-Compliant ReAct Agentic Loop for Optical Networks: Generic vs. Domain-Specific Tool Abstractions](https://arxiv.org/abs/2606.18000)
...
### [26] [User-Mobility-Aware Optimization of Fiber Placement in Hybrid Fiber-IAB Networks](https://arxiv.org/abs/2606.18016)
...
### [27] [Energy-Efficient FSO Reconfiguration under User Mobility in Hybrid Fiber-IAB Backhaul](https://arxiv.org/abs/2606.18017)
*Piotr Lechowicz,Charitha Madapatha,Carlos Natalino,Tommy Svensson,Paolo Monti*
...
### [28] [OmniPlan: An Adaptive Framework for Timely and Near-Optimal Network Planning Optimization](https://arxiv.org/abs/2606.18105)
...
### [29] [The Multipath Reliable Connection (MRC) Transport](https://arxiv.org/abs/2606.18170)
...
### [30] [LogCopilot: Automating Log Aggregation Analysis through Large Language Models](https://arxiv.org/abs/2606.17094)
...
### [31] [Software Delegation Contracts: Measuring Reviewability in AI Coding-Agent Work](https://arxiv.org/abs/2606.17099)
*Vincent Schmalbach*
...
### [32] [Cluster-Aware Dual-Level Test Specification Generation for Large-Scale Automotive Software Requirements](https://arxiv.org/abs/2606.17197)
...
### [33] [Trust-Aware Multi-Agent Traceability: Confidence-Calibrated Knowledge Graphs for Consistent Software Artifact Management](https://arxiv.org/abs/2606.17203)
...
### [34] [Supporting the Adoption of Privacy-Enhancing Technologies through Requirements Engineering](https://arxiv.org/abs/2606.17387)
...
### [35] [OmniDroneX: An LLM-Assisted Holistic Drone-as-a-Service Ecosystem](https://arxiv.org/abs/2606.17510)
...
### [36] [Unlocking LLM Code Correction with Iterative Feedback Loops](https://arxiv.org/abs/2606.17514)
...
### [37] [Understanding LLMs in Title-Abstract Screening: From Disagreements to Recommendations](https://arxiv.org/abs/2606.17588)
...
### [38] [Why Model Credibility Isn't Enough: -Rethinking Trust in Simulation Architectures](https://arxiv.org/abs/2606.17593)
...
### [39] [PracRepair: LLM-Empowered Automated Program Repair Inspired by Human-Like Debugging Practices](https://arxiv.org/abs/2606.17612)
...
### [40] [FacProcessTwin: An LLM-Based System for Process Twin Development](https://arxiv.org/abs/2606.17666)
...
### [41] [Position: Coding Benchmarks Are Misaligned with Agentic Software Engineering](https://arxiv.org/abs/2606.17799)
...
### [42] [A Framework for Evaluating Agentic Skills at Scale](https://arxiv.org/abs/2606.17819)
...
### [43] [Planning to Hammer: Difficulty-Aware Decomposition for Automating Rocq Proofs](https://arxiv.org/abs/2606.17981)
...
### [44] [All Smoke, No Alarm: Oracle Signals in Agent-Authored Test Code](https://arxiv.org/abs/2606.18168)
...
### [45] [The Right Call for Software Benchmarking: Consistent Decisions in Stateful Environments](https://arxiv.org/abs/2606.17261)
*Gábor Melis*
...
### [46] [Cordon: Semantic Transactions for Tool-Using LLM Agents](https://arxiv.org/abs/2606.17573)
...
### [47] [Evaluating LLM Coding Agents on SZ-Family Lossy Compression Across Architectures](https://arxiv.org/abs/2606.17058)
...
### [48] [Towards Distributed Inference of LLMs on a P2P Network](https://arxiv.org/abs/2606.17059)
...
### [49] [Local Fault Repair of Perfect Resource Placements in Eisenstein--Jacobi Networks](https://arxiv.org/abs/2606.17288)
*Bader Albader*
...
### [50] [Space-Efficient Lock-Free Linear-Probing Hash Table](https://arxiv.org/abs/2606.17315)
...
### [51] [RISE: Relay Inference and Online Scheduling for Efficient Edge-Device Collaborative Diffusion Model Services](https://arxiv.org/abs/2606.17378)
...
### [52] [SpecGen: Accelerating Agentic Kernel Optimization with Speculative Generation](https://arxiv.org/abs/2606.17518)
...
### [53] [Local Fault Repair of Perfect Resource Placements in Dense Gaussian Networks](https://arxiv.org/abs/2606.17527)
*Bader Albader*
...
### [54] [Multi-Orientation Edge-Minimum Repair for Non-Redundant Fault-Tolerant Broadcasting in Dense Gaussian Networks](https://arxiv.org/abs/2606.17528)
*Bader Albader*
...
### [55] [AoiZora: Topology-Aware Auto-Parallel Optimization for Inference of Diffusion Transformers](https://arxiv.org/abs/2606.17566)
...
### [56] [From GPU to Microcontroller: Online Ridge Regression for Edge-Deployable Traffic Prediction](https://arxiv.org/abs/2606.17613)
...
### [57] [LUMEN: Coordinated Failure Recovery for Distributed LLM Serving](https://arxiv.org/abs/2606.17787)
...
### [58] [An Epistemic Analysis of Random Coordinated Attack](https://arxiv.org/abs/2606.17860)
...
### [59] [RouteBalance: Fused Model Routing and Load Balancing for Heterogeneous LLM Serving](https://arxiv.org/abs/2606.17949)
...
### [60] [Latency Prediction for LLM Inference on NPU Systems](https://arxiv.org/abs/2606.18042)
